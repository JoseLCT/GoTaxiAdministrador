...
public class AIPasajero extends JPanel implements Interfaz {
    ...
    public AIPasajero(Dimension tamano) {
        this.tamano = tamano;
    ...
    private void init() {
        ...
        //superior
        lb_titulo = new JLabel("PASAJEROS", SwingConstants.CENTER);
        ...
        btn_ordenar.addActionListener(e -> {
            if (ordenar == false) {
                ...
                tbl_historial.setModel(pasajeroDao.getDatosAsc());
                ordenar = true;
            } else {
                PasajeroDao pasajeroDao = new PasajeroDao();
                tbl_historial.setModel(pasajeroDao.getDatosDesc());
                ordenar = false;
            }
        });
        btn_menu.addActionListener(e -> {
            notificador.firePropertyChange("aipasajero_aimenu", null, null);
        });
        btn_conductor.addActionListener(e -> {
            notificador.firePropertyChange("aipasajero_aiconductor", null, null);
        });
    }
